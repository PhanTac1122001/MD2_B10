package baitap.validate;

import baitap.service.CategoryService;
...
public class CategoryValidate {
    ...
    public static String inputCategoryName(Scanner scanner){
        while (true){
            ...
            if(categoryName.length() >= 6 && categoryName.length() <= 30){
                ...
                System.err.println("Tên danh mục phải từ 6->50 ký tự, vui lòng nhâp lại");
            }
        }
    }
    public static boolean inputCategoryStatus(Scanner scanner){
        while (true){
            ...
            String categoryStatus = scanner.nextLine().toLowerCase();
